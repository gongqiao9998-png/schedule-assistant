...
function extractInviteFromMail(raw) {
  ...
  return {
    ...
    invite: {
      ...
      startAt: ics?.startAt || parseDateTimeFromText(parsedMail.textBody || parsedMail.htmlBody || ""),
      endAt: ics?.endAt || null,
      location: ics?.location || extractLocation(parsedMail.textBody || parsedMail.htmlBody || ""),
      organizer: ics?.organizer || parsedMail.from || "",
      meetingLink: ics?.meetingLink || extractMeetingLink(parsedMail.textBody || parsedMail.htmlBody || ""),
